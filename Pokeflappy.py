...
>>>>>>> f13e25ed894ed32a2f0c77bb54338433e0daf0b8
    ...
    class Personagem(pygame.sprite.Sprite):
        def __init__(self):
            ...
            self.image = pygame.image.load(
                'images/magikarp.png').convert_alpha()
            poke_size = (90, 90)
...
>>>>>>> f13e25ed894ed32a2f0c77bb54338433e0daf0b8
            ...
            if volup_button.draw(screen): #Aumenta o volume ao clicar o botão "+"
                if (volume < 1 and volume_texto < 100):
                    volume += 0.1
                    volume_texto += 10
                    volume_text = fonte_menu.render(
                        str(volume_texto), 1, (255, 255, 255))
                    pygame.mixer.music.set_volume(volume)
